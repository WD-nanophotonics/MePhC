...
def test_mcp_tool_set_stays_typed_and_describes_zero_idle_resume():
    ...
    assert set(tools) == {"mephc_capabilities", "mephc_doctor", "mephc_resume", "mephc_change", "mephc_validate", "mephc_submit", "mephc_native", "mephc_status", "mephc_wait", "mephc_recover", "mephc_retention_search"}
