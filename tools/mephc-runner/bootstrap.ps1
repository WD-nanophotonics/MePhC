...
$Files=@('worker.py','jobctl.py','workflow.py','workflow_resume.py','runtime_config.py','checkout_manager.py','user_runtime.py','home_cleanup.py','migrate_state.py','migrate_canary_metadata.py','windows_materializer.py','windows_broker.py','materialize_client.py','mcp_server.py','native-recipes.json','mephc-runner.ps1','mephc-runner.cmd','mephc-connector.cmd','mephc-connector.ps1','mephc-runner.service','README.md')
$Manifest=@()
