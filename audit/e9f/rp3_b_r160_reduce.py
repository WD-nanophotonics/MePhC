...
def main():
    ...
    out={"schema":"mephc_e9f_c1_rp3_b_r160_compact_trace_v1","work_order_id":result["work_order_id"],"execution_sha":result["execution_sha"],"source_r128_execution_sha":"39b63b80bf42d48e5b256dd1a211f6bec2585cd4","raw_runtime_root":str(RUNTIME),"raw_result_sha256":sha(RUNTIME/"rp3_b_r160_result.json"),"raw_manifest_sha256":sha(RUNTIME/"rp3_b_r160_manifest.json"),"raw_checkpoint_sha256":sha(RUNTIME/"matrix_checkpoint.json"),"authorized_native_solve_count":54,"actual_native_solve_count":result["actual_native_solve_count"],"worker_count":6,"entry_count":12,"replay_policy":result["replay_policy"],"convergence_rows":rows,"spectral_rows":spectral,"measurements":meas,"entries":entries,"no_convergence_verdict":True,"diagnostic_only":True,"reducer_admissible":False}
