"""Expose verified P17 outcome as a bounded scalar-only P21 result."""
...
WORK_ORDER_ID = "MEPHC-LOCALAFFINE-P21-P17-OUTCOME-EXPOSE-20260830-385"
...
def main() -> int:
    ...
    write_result({
        "schema": "mephc-local-affine-p21-p17-outcome-expose-v1",
        ...
        "p17_classification": nested["classification"],
        "p17_child_return_code": nested.get("child_return_code"),
        ...
        "p17_provider_path_used": nested.get("exact_production_local_affine_provider_path_used") is True,
