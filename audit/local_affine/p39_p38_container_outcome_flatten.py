"""Flatten the verified P38 tuple-versus-list outcome without rerunning science."""
...
WORK_ORDER_ID = "MEPHC-LOCALAFFINE-P39-P38-CONTAINER-OUTCOME-FLATTEN-20260830-403"
...
def main() -> int:
    ...
    require(a.get("geometry_container") == "tuple", "P38_PROBE_A_CONTAINER_INVALID")
    require(b.get("geometry_container") == "list", "P38_PROBE_B_CONTAINER_INVALID")
    require(b.get("underlying_geometry_objects_shared") is True, "P38_GEOMETRY_IDENTITY_INVALID")
    require(b.get("lattice_object_shared") is True, "P38_LATTICE_IDENTITY_INVALID")

    write_result({
        "schema": "mephc-local-affine-p39-p38-container-outcome-v1",
        ...
        "probe_a_geometry_container": a.get("geometry_container"),
        "probe_b_geometry_container": b.get("geometry_container"),
        "probe_b_same_underlying_geometry_objects_verified": True,
        "probe_b_same_lattice_object_verified": True,
